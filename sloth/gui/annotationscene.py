...
class AnnotationScene(QGraphicsScene):
    ...
    def onInsertionModeEnded(self):
        if self._inserter is not None:
            self._inserter.abort()
        #Abhishek Start: Setting arrow cursor for SceneView (image view)
        self._labeltool._mainwindow.view.setCursor((QCursor(Qt.ArrowCursor)))
        #Abhishek End: Setting arrow cursor for SceneView (image view)
